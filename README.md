...
3. Add `VITE_GIPHY_API_KEY` in Vercel environment variables
4. Deploy
...
Powered by [GIPHY](https://giphy.com)# GIF Picker
...
```bash
git clone https://github.com/yourusername/gif-picker.git
cd gif-picker
```
